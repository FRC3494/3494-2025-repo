...
public class Module {
  private static final double WHEEL_RADIUS = Units.inchesToMeters(2.0025942377763206);//2.02368);//2.0775374216272326);//2.50410195);//2.450789576520621);//1.6703883408404518 inches//1.6723303021786367 inches //1.671774376846477);//2.031000299198190);
