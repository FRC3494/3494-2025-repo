...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    OI.ToggleDefenseMode().rising().ifHigh(()->{
        groundIntake.setDefenseMode(!groundIntake.defenseMode).schedule();
    });
    controller.
        leftBumper()
        ...
        Commands.sequence(
          ...
          new InstantCommand(() -> {
            ...
            new InstantCommand(() -> {
                ...
                groundIntake.setIntakePower(-0.75, 0.5);
    ...
    OI.activateGroundIntake().falling().ifHigh(()->{
        Commands.sequence(
            ...
            //TODO
            groundIntake.setIntaking(false),
            groundIntake.setIntakePower(0, 0)
        ).schedule();
    });
    ...
    OI.bargeYeet2().rising().ifHigh(()->{//THE SECOND ONE!!!!!!!!!!!
        Commands.sequence(
            new InstantCommand(() -> {arm.setCurrentLimit(90);}),
            // new InstantCommand(() -> {elevator.setPIDlimits(-1, 1);}),
            new InstantCommand(() -> {arm.setPIDlimits(-1, 1);}),
            new InstantCommand(() -> {arm.setPID(12, 0.0, 0.0);}), 
            new InstantCommand(() -> {intake.setSpeed(0.5);}),
